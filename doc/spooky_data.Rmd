...
ggplot(afinnscore_all, aes(author, sentiment, fill = author)) +
...
ggplot(afinnscore_trend, aes(index, sentiment, fill = author)) +
  geom_col(show.legend = F) + 
...
## n-grams: Relationships between Words 
***
...
ggplot(EAP_long, aes(variable, value, fill = variable)) + 
...
ggplot(MWS_long, aes(variable, value, fill = variable)) + 
  geom_bar(stat = "identity", position = "dodge") +
...
ggplot(HPL_long, aes(variable, value, fill = variable)) + 
